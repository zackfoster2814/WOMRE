...
export function registerRaces() {
  ...
  defineEffect('race', 'Symbiosis')
    .description('Kí sinh lên 1 người chơi. Tiền thưởng chia đều. Khi host chết, bạn cũng bị loại.')
    .weight(1.5)
    .tier(1)
    .effect({
      type: 'custom',
  ...
  defineEffect('race', 'Skeleton')
    .description('Sau 2 PvP thắng: tiến hóa Lich (IQ=8). Sau 4 PvP thắng: Lich King (+1 all). Miễn nhiễm AIDS.')
    .weight(5.25)
    .tier(8)
    .immuneTo('AIDS')
    .effect({
  ...
  defineEffect('race', 'Dryad')
    .description('Khi Dryad khác chết: +2 random stat. Dryad cuối cùng: tiến hóa Yggdrasil +9 random stat.')
    .weight(4.5)
    .tier(7)
    .effect({
      type: 'stat_modifier',
  ...
  defineEffect('race', 'Spirit')
    .description('Mỗi round thua: +1 stack Souls. 6 stack: +2 BIQ. 9 stack: +1 Power. 13 stack: +1 all. 20 stack: gấp đôi. Miễn nhiễm AIDS.')
    .weight(4.5)
    .tier(7)
    .immuneTo('AIDS')
    .effect({
  ...
  defineEffect('race', 'Uma')
    .description('Thuộc House "Tracen Academy", không có vòng quay House.')
    .weight(4.5)
    .tier(7)
    .effect({
      type: 'house_assign',
  ...
  defineEffect('race', 'Giant')
    .description('+5 IQ nếu IQ > Str (-5 Str). +5 Str nếu Str > IQ (-5 IQ). Bằng nhau: +3 cả hai.')
    .weight(4)
    .tier(6)
    .effect({
      type: 'stat_modifier',
  ...
  defineEffect('race', 'Reincarnator')
    .description('Chuyển sinh thành player mùa 2.5, nhận Base Stats và tộc của người đó.')
    .weight(2)
    .tier(3)
    .unique()
    .effect({
  ...
  defineEffect('race', 'Angel')
    .description('Nhận Archetype "Pacifist" từ đầu (sẽ nhận thêm một Archetype nữa).')
    .weight(3.5)
    .tier(5)
    .effect({
  ...
  defineEffect('race', 'Demi-God')
    .description('+1 all stats vs Human, -1 all stats vs God.')
    .weight(3.5)
    .tier(5)
    .effect({
      type: 'stat_modifier',
  ...
  defineEffect('race', 'Primordial Being')
    .description('Mỗi khi thắng Combat, nhận lại Elemental Wheel một lần nữa.')
    .weight(3.5)
    .tier(5)
    .effect({
      type: 'wheel_grant',
...
EffectEntryBuilder.prototype.grantGear = function(name: string = 'random', count: number = 1) {
  return this.effect({
    type: 'grant_gear',
    grantType: 'gear',
    grantName: name,
