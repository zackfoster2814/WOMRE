...
export function registerAllHouseEffects() {
  ...
  defineEffect('house', 'The Shire')
    .description('Nhận +4 vào 1 Stat bất kì. Archetype Mason: Nhận +6 vào 1 Stat bất kì.')
    .effect({
      type: 'stat_modifier',
      stat: 'random',
      value: 4,
  ...
  defineEffect('house', 'New London')
    .description('Không có Mason Effect. Nhận thêm 1 trong 9 Archetype: Frostlanders, New Londoners, Wanderers, etc.')
    .effect({
      type: 'grant_wheel',
  ...
  defineEffect('house', 'Winterhome')
    .description('Nhận 2 Normal Gear và +2 Dura. Archetype Mason: Nhận 2 Normal Gear và +1 vào all stats.')
    .effect({
      type: 'grant_gear',
      grantType: 'gear',
      grantName: 'random',
  ...
  defineEffect('house', 'Atreides')
    .description('Nhận +2 vào Base Stat Cao Nhất. Archetype Mason: Sau Combat: Nhận +1 vào Base Stat Cao Nhất.')
    .effect({
      type: 'stat_modifier',
      stat: 'highest',
      value: 2,
  ...
  defineEffect('house', 'House Lannister')
    .description('Nhận 3 Gear "Golden Coin" và 2 Gear ngẫu nhiên. Archetype Mason: Nhận 6 Gear "Golden Coin" và 2 Gear ngẫu nhiên.')
    .effect({
      type: 'grant_gear',
      grantType: 'gear',
  ...
  defineEffect('house', 'House Stark')
    .description('Nhận 1 "Dire Wolf". Archetype Mason: Nhận 1 "Dire Wolf" và 1 Unique Weapon.')
    .effect({
      type: 'grant_wheel',
  ...
  defineEffect('house', 'House Targaryen')
    .description('Không có Mason Effect. Nhận 3 quả trứng rồng. Trứng sẽ nở ở vòng 16.')
    .effect({
      type: 'grant_gear',
      grantType: 'gear',
  ...
  defineEffect('house', 'House Baratheon')
    .description('Nhận +1 Str, +1 BIQ, +1 MA, Base Stat thấp nhất sẽ được +2. Archetype Mason: Nhận thêm +1 all stats.')
    .addStat('strength', 1)
    .addStat('biq', 1)
    .addStat('ma', 1)
    .effect({
  ...
  defineEffect('house', 'Dothraki')
    .description('Không có Mason Effect. Trong Combat: Stat được đọ trong trận sẽ tuân theo luật ngẫu nhiên.')
    .effect({
      type: 'custom',
  ...
  defineEffect('house', 'House Tyrell')
    .description('Sau Combat: Nhận +2 vào Base Stat thấp nhất. Archetype Mason: Sau Combat: Nhận +3 vào Base Stat thấp nhất.')
    .effect({
      type: 'stat_modifier',
      stat: 'lowest',
      value: 2,
  ...
  defineEffect('house', "Kazuya Kinoshita's House")
    .description('Sau Combat: Nhận 1 Gear "Golden Coin". Archetype Mason: Sau Combat: Nhận 1 Gear "Golden Coin" và +1 vào Stat thấp nhất.')
    .effect({
      type: 'grant_gear',
      grantType: 'gear',
      grantName: 'Golden Coin',
  ...
  defineEffect('house', 'Shurima')
    .description('Nhận 1 Legacy Gear và 2 Power. Archetype Mason: Nhận 1 Legacy Gear và 1 Unique Weapon.')
    .effect({
      type: 'grant_gear',
      grantType: 'gear',
  ...
  defineEffect('house', 'Hallownest')
    .description('Chắc chắn có Weapon, chắc chắn có 2 Rune lên Weapon đó. Archetype Mason: Thêm 1 Rune.')
    .effect({
      type: 'custom',
      timing: 'immediate',
      target: 'self',
  ...
  defineEffect('house', 'Coven Council')
    .description('Không có Mason Effect. Nhận +4 IQ. Khi Player đến từ Coven Council bị loại, 1 Player random khác cùng house nhận +2 IQ.')
    .addStat('iq', 4)
    .effect({
      type: 'custom',
      timing: 'on_death',
  ...
  defineEffect('house', 'Golden Order')
    .description('Nhận 1 Great Rune và 2 Power. Archetype Mason: Nhận 1 Great Rune và Char Dev Shardbearer.')
    .effect({
      type: 'grant_wheel',
  ...
  defineEffect('house', 'Roundtable Hold')
    .description('Không có Mason Effect. Khi bạn thua và đứng trước ngưỡng cửa bị loại, đánh lại 1 round. Kích hoạt 1 lần.')
    .effect({
      type: 'custom',
  ...
  defineEffect('house', 'Uchiha')
    .description('Không có Mason Effect. Nhận +2 Dura và +2 BIQ. Mỗi khi đánh bại một người trong combat, nhận +1 Stat cao nhất.')
    .addStat('durability', 2)
    .addStat('biq', 2)
    .effect({
      type: 'stat_modifier',
  ...
  defineEffect('house', 'Ban Nhạc Ngọt Đoàn Kết')
    .description('Nhận 1 trong 5 Gear: Kẹo, Ớt, Mì Tôm, Bò Khô, Radio. Mason Effect: Nhận 2 trong 5 Gear.')
    .effect({
      type: 'grant_wheel',
  ...
  defineEffect('house', 'Naga')
    .description('Gia tộc của nữ hoàng Azshara chỉ nhận Merfolk. Không có Mason Effect. Nhận 1 Blessing of the Deep.')
    .effect({
      type: 'grant_wheel',
  ...
  defineEffect('house', 'Tracen Academy')
    .description('Học Viện chỉ nhận Uma. Nhận ngẫu nhiên từ 1-3 Strength, 1-3 Speed và 1-3 Durability.')
    .effect({
      type: 'custom',
      timing: 'immediate',
      target: 'self',
...
function registerHouseSubTypes() {
  ...
  defineEffect('house_sub', 'Grey Wind')
    .description('Khi nhận Sói: +2 Stat thấp nhất và Cao Nhất. Khi bị loại: Người nhà Stark +1 all stats.')
    .weight(16.67)
    .effect({
      type: 'stat_modifier',
      stat: 'lowest',
  ...
  defineEffect('house_sub', 'Lady')
    .description('Khi nhận Sói: +2 all stats trong Combat kế. Sau Combat Thua: +2 all stats combat kế.')
    .weight(16.67)
    .effect({
      type: 'stat_modifier',
      stat: 'all',
  ...
  defineEffect('house_sub', 'Shaggydog')
    .description('Khi nhận Sói: +1 Stat thấp nhất. Sau mỗi Combat: Người nhà Stark +1 Stat thấp nhất.')
    .weight(16.67)
    .effect({
      type: 'stat_modifier',
      stat: 'lowest',
  ...
  defineEffect('house_sub', 'Nymeria')
    .description('Khi nhận Sói: +3 Speed. Sau Combat Thua: Nhận Power "Weapon Enhancing".')
    .weight(16.67)
    .addStat('speed', 3)
    .effect({
      type: 'grant_power',
  ...
  defineEffect('house_sub', 'Unborn')
    .description('Re-Spin lại chỉ số thấp nhất 1 lần. +4 vào Stat thấp nhất sau đó.')
    .weight(13)
    .effect({
      type: 'stat_respin',
      stat: 'lowest',
  ...
  defineEffect('house_sub', 'Mohg')
    .description('Sau mỗi trận đấu, +2 vào Stat thấp nhất và +1 vào Stat bất kì.')
    .weight(13)
    .effect({
      type: 'stat_modifier',
      stat: 'lowest',
  ...
  defineEffect('house_sub', 'Might')
    .description('Chỉ số có Base cao nhất bị kéo xuống 0. Với mỗi 3 điểm mất đi, nhận +1 vào all stats khác.')
    .weight(30)
    .effect({
      type: 'custom',
      timing: 'immediate',
  ...
  defineEffect('house_sub', 'Reforge')
    .description('Nhận 1 Rune nếu có thể. Nếu không thể, nhận +1 all stats thay vào đó.')
    .weight(30)
    .effect({
      type: 'custom',
      timing: 'immediate',
  ...
  defineEffect('house_sub', 'Atreides Mason')
    .description('(Mason) Nhận +2 vào Base Stat Cao Nhất. Sau Combat: Nhận +1 vào Base Stat Cao Nhất.')
    .effect({
      type: 'stat_modifier',
      stat: 'highest',
      value: 2,
  ...
  defineEffect('house_sub', 'House Baratheon Mason')
    .description('(Mason) Nhận +1 Str, +1 BIQ, +1 MA, Base Stat thấp nhất +2, và thêm +1 all stats.')
    .addStat('strength', 1)
    .addStat('biq', 1)
    .addStat('ma', 1)
    .effect({
  ...
  defineEffect('house_sub', "Kazuya Kinoshita's House Mason")
    .description('(Mason) Sau Combat: Nhận 1 Gear "Golden Coin" và +1 vào Stat thấp nhất.')
    .effect({
      type: 'grant_gear',
      grantType: 'gear',
      grantName: 'Golden Coin',
  ...
  defineEffect('house_sub', 'Hallownest Mason')
    .description('(Mason) Chắc chắn có Weapon, chắc chắn có 3 Rune lên Weapon đó.')
    .effect({
      type: 'custom',
      timing: 'immediate',
      target: 'self',
