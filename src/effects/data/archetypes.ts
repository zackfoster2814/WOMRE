...
export function registerAllArchetypeEffects() {
  ...
  defineEffect('archetype', 'Promised Consort')
    .description('Trong Combat: Thêm Base Stat cao nhất của Lover vào stat đánh nhau. Ưu tiên Lover có Archetype "Femboy".')
    .weight(0.5)
    .effect({
      type: 'custom',
      timing: 'during_combat',
  ...
  defineEffect('archetype', 'Stargazer')
    .description('Nhận Power "Spell Flux" và 1 Power có kích hoạt "Trong Combat" ngẫu nhiên. (Đã nhận lúc tạo nhân vật)')
    .weight(0.5)
    .register();
  ...
  defineEffect('archetype', 'Superhero')
    .description('Bạn là một siêu anh hùng! Nhận "Siêu Anh Hùng Wheel". (Đã quay lúc tạo nhân vật)')
    .weight(1.6)
    .effect({
      type: 'grant_wheel',
  ...
  defineEffect('archetype', 'Người Trong Ban Nhạc')
    .description('36% nhận "Instrument Weapon Wheel". Skip vũ khí thường. Mặc định House "Ban Nhạc Ngọt Đoàn Kết". (Đã xử lý lúc tạo nhân vật)')
    .weight(3)
    .effect({
      type: 'custom',
      timing: 'immediate',
  ...
  defineEffect('archetype', 'Gambler')
    .description('Trong combat: Mỗi round thắng có 50% nhận 2 điểm và 50% nhận 0 điểm.')
    .weight(2.2)
    .effect({
      type: 'custom',
      timing: 'on_round_win',
  ...
  defineEffect('archetype', 'Time Traveller')
    .description('Khi spin Base Stats, stat ≤3 sẽ spin lại 1 lần. (Đã xử lý lúc tạo nhân vật)')
    .weight(1.8)
    .register();
  ...
  defineEffect('archetype', 'Loyal')
    .description('Nhận 1 Lover và chỉ có 1 Lover duy nhất. Khi Lover bị loại: +1 Char Dev. (Lover đã nhận lúc tạo nhân vật)')
    .weight(2.2)
    .effect({
      type: 'custom',
      timing: 'immediate',
  ...
  defineEffect('archetype', 'Trickster')
    .description('Nhận "Trickster Wheel", kích hoạt trước mỗi combat và hết hiệu lực sau combat. (Đã quay lúc tạo nhân vật)')
    .weight(2.2)
    .effect({
      type: 'grant_wheel',
  ...
  defineEffect('archetype', 'Edgelord')
    .description('Trước khi kết thúc combat: Bên thấp điểm hơn nhận thêm 1 điểm.')
    .weight(2.8)
    .effect({
      type: 'custom',
  ...
  defineEffect('archetype', 'Hero of the Emirate🍀')
    .description('Nhận thêm Quirk 🍀 và Power 🍀 ngay lập tức. (Đã nhận lúc tạo nhân vật)')
    .weight(3.6)
    .register();
  ...
  defineEffect('archetype', 'Fisher')
    .description('Nhận Gear "Fishing Rod". Đến vòng 16: +1 PvP Rewards. (Gear đã nhận lúc tạo nhân vật)')
    .weight(2.2)
    .effect({
      type: 'custom',
      timing: 'on_round_16',
  ...
  defineEffect('archetype', 'Blacksmith')
    .description('Chắc chắn có vũ khí. Vũ khí chắc chắn là runeword. Dùng được mọi vũ khí. (Đã xử lý lúc tạo nhân vật)')
    .weight(2.2)
    .effect({
      type: 'custom',
      timing: 'immediate',
  ...
  defineEffect('archetype', 'Gambler Bloodline')
    .description('50% không được quay vòng quay đó, stat mặc định = 1. Nếu không quay được stat nào -> all stats = 10. Nếu không quay được gì -> vô địch! (Đã xử lý lúc tạo nhân vật)')
    .weight(1.9)
    .register();
  ...
  defineEffect('archetype', 'Power Ranger')
    .description('Bạn trở thành 1 trong các siêu nhân Gao! Nhận "Power Ranger Wheel". (Đã quay lúc tạo nhân vật)')
    .weight(1.5)
    .effect({
      type: 'grant_wheel',
  ...
  defineEffect('archetype', 'Invoker')
    .description('Nhận 3 Power "Quas", "Wex", "Exort". Trước Combat: Quay 1 Power chưa sở hữu và nhận hiệu ứng trong combat đó. (Power đã nhận lúc tạo nhân vật)')
    .weight(1)
    .effect({
      type: 'custom',
      timing: 'before_combat',
  ...
  defineEffect('archetype', 'Bravest of the Brave')
    .description('Không được vòng quay Power. Thắng combat PvP: Nhận 2 PvP Rewards thay vì 1. (Đã xử lý lúc tạo nhân vật)')
    .weight(1)
    .effect({
      type: 'custom',
      timing: 'after_combat_win',
  ...
  defineEffect('archetype', 'Mason')
    .description('Cường hóa House Feature khi nhận Houses. (Không nhận House Feature thông thường)')
    .weight(3)
    .effect({
      type: 'custom',
      timing: 'immediate',
  ...
  defineEffect('archetype', 'Cursed of 36k')
    .description('Giảm toàn bộ Base Stat quay ra đi 1. (Cái tội sống vội + ham hố)')
    .weight(0)
    .addAllStats(-1, true)
    .register();
  ...
  defineEffect('archetype', 'X')
    .description('Unique - chỉ 1 người có. Thua -> chuyển cho người thắng. Nhận "Hero X Wheel". Mất archetype -> -1 all stats. (Đã quay lúc tạo nhân vật)')
    .weight(0)
    .effect({
      type: 'grant_wheel',
...
function registerWibuSubTypes() {
  ...
  defineEffect('archetype_sub', 'King Crimson')
    .description('Nhận +4 MA. Trong Combat: Mỗi khi thắng 1 round, +2 stat round kế.')
    .weight(12)
    .addStat('ma', 4)
    .effect({
      type: 'custom',
  ...
  defineEffect('archetype_sub', 'Golden Experience Requiem')
    .description('Trong Combat: Thua round -> đánh lại (mỗi stat 1 lần). Đối phương Crit thành công -> quay lại Crit Wheel (max 2 lần).')
    .weight(7)
    .effect({
      type: 'custom',
      timing: 'during_combat',
  ...
  defineEffect('archetype_sub', 'Infinity')
    .description('Trong Combat: Speed đối phương = 1. Đối phương +8 IQ, nếu IQ ≥ 14 thì bạn +2 điểm.')
    .weight(8)
    .effect({
      type: 'custom',
      timing: 'during_combat',
  ...
  defineEffect('archetype_sub', 'Malevolent Shrine')
    .description('+1 Str, +1 MA. Trong Combat: +1 điểm thêm khi thắng round Str/MA.')
    .weight(12)
    .addStat('strength', 1)
    .addStat('ma', 1)
    .effect({
  ...
  defineEffect('archetype_sub', 'Idle Death Gamble')
    .description('Trước Combat: 8% +100 all stats, 22% +1 all stats, 70% không gì. Vô hiệu hóa toàn bộ Power khác.')
    .weight(20)
    .effect({
      type: 'custom',
      timing: 'before_combat',
  ...
  defineEffect('archetype_sub', 'Self-Embodiment of Perfection')
    .description('Trong Combat: Thắng 3 round -> thắng ngay. -1 all stats. Yếu hơn các thắng ngay khác.')
    .weight(20)
    .addAllStats(-1)
    .effect({
      type: 'custom',
  ...
  defineEffect('archetype_sub', 'Erasure')
    .description('Trong combat: Vô hiệu hóa tối đa 3 Power ngẫu nhiên của đối phương.')
    .weight(11)
    .effect({
      type: 'disable_powers',
      count: 3,
  ...
  defineEffect('archetype_sub', 'Half-Cold Half-Hot')
    .description('Trong combat: 50% -1 all stats đối thủ. 50% +1 all stats bạn. (Riêng biệt)')
    .weight(11)
    .effect({
      type: 'custom',
      timing: 'during_combat',
  ...
  defineEffect('archetype_sub', 'Float')
    .description('+2 Speed. Thắng round Speed -> +1 điểm cuối combat. Sau combat thắng -> +1 Speed.')
    .weight(7)
    .addStat('speed', 2)
    .effect({
      type: 'custom',
  ...
  defineEffect('archetype_sub', 'Hellflame')
    .description('+1 all stats. Sau 2 combat thắng -> +1 thêm. Thua -> reset về +1.')
    .weight(7)
    .effect({
      type: 'custom',
      timing: 'immediate',
  ...
  defineEffect('archetype_sub', 'Rewind')
    .description('Đưa đối thủ về trạng thái vòng trước (loại bỏ PvP Rewards và hiệu ứng). Vĩnh viễn.')
    .weight(7)
    .effect({
      type: 'custom',
      timing: 'during_combat',
  ...
  defineEffect('archetype_sub', 'Overhaul')
    .description('Thắng Speed và MA -> thắng ngay. Mỗi lần không kích hoạt -> +1 Speed, +1 MA.')
    .weight(6)
    .effect({
      type: 'custom',
      timing: 'during_combat',
  ...
  defineEffect('archetype_sub', 'One For All')
    .description('+3 Str, +3 Speed, +3 Dur. Không thể vô hiệu. Chung kết: gấp đôi bonus. Unique.')
    .weight(2)
    .addStat('strength', 3)
    .addStat('speed', 3)
    .addStat('durability', 3)
  ...
  defineEffect('archetype_sub', 'All For One')
    .description('Trong combat: Nhận 1 hiệu ứng MHA ngẫu nhiên (không phải One For All). Thắng -> giữ vĩnh viễn. Unique.')
    .weight(2)
    .effect({
      type: 'custom',
      timing: 'during_combat',
...
function registerFarmerSubTypes() {
  ...
  defineEffect('archetype_sub', 'Aura Farmer')
    .description('+2 all stats. Vào chung kết không thua PvP -> +1 all stats. Thua -> mất aura và Farmer.')
    .weight(15)
    .addAllStats(2)
    .effect({
      type: 'custom',
...
function registerNewLondonArchetypes() {
  ...
  defineEffect('archetype', 'Merchants')
    .description('Nhận 1 "Đồng Tiền Vàng". Sau Combat: Bán 1 Gear lấy 1 "Đồng Tiền Vàng".')
    .weight(0)
    .effect({
      type: 'grant_gear',
      grantType: 'gear',
  ...
  defineEffect('archetype', 'Evolvers')
    .description('Chuyển tất cả Debuff của đối thủ dành cho mình thành Buff tặng cho mình.')
    .weight(0)
    .effect({
      type: 'custom',
      timing: 'during_combat',
  ...
  defineEffect('archetype', 'Pilgrims')
    .description('Biến đổi Debuff của bản thân thành Buff tăng chỉ số cho mình.')
    .weight(0)
    .effect({
      type: 'custom',
      timing: 'during_combat',
  ...
  defineEffect('archetype', 'Bohemians')
    .description('Trong Combat: Tất cả vòng quay 40/40/20 (20% hòa). All Stats = 99.')
    .weight(0)
    .effect({
      type: 'custom',
      timing: 'during_combat',
  ...
  defineEffect('archetype', 'Icebloods')
    .description('Trong Combat: +1 điểm nếu thắng round, -1 điểm nếu thua round.')
    .weight(0)
    .effect({
      type: 'custom',
      timing: 'during_combat',
  ...
  defineEffect('archetype', 'Menders')
    .description('Sau Combat: Stat thấp nhất đối thủ +2 cho mình, Stat cao nhất +1 cho mình.')
    .weight(0)
    .effect({
      type: 'custom',
      timing: 'after_combat',
  ...
  defineEffect('archetype', 'Overseers')
    .description('Trong Combat: Cả hai chỉ chọn 1 Power "Trong Combat". Đối thủ -1 all stats.')
    .weight(0)
    .effect({
      type: 'stat_modifier',
      stat: 'all',
...
function registerTricksterSubTypes() {
  ...
  defineEffect('archetype_sub', 'Ace of Spades')
    .description('Sau khi kết thúc tính điểm combat, điểm của bạn là điểm của đối phương và ngược lại.')
    .weight(10)
    .effect({
      type: 'custom',
