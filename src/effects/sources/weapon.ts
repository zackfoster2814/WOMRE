...
export function registerAllWeaponEffects() {
  ...
  defineEffect("weapon", "Banana Peel")
    .description(
      "Trước Combat: Nhận -1 all stats nếu có Base IQ thấp hơn đối phương. Nhận +1 all stats nếu có Base IQ cao hơn đối phương.",
    )
    .weight(2.86)
    .effect({
      type: "custom",
  ...
  defineEffect("weapon", "Glass Bottle")
    .description(
      "(1).Nhận +2 all stats. (2).Sau Combat: Loại bỏ vũ khí này. (3) Vũ khí này không thể khảm Rune.",
    )
    .weight(2.86)
    .addAllStats(2)
    .effect({
  ...
  defineEffect("weapon", "Cursed Pennywort")
    .description(
      "Trước Combat: 36% vô hiệu hóa 3 power ngẫu nhiên của đối thủ.",
    )
    .weight(2.86)
    .effect({
      type: "custom",
  ...
  defineEffect("weapon", "Hidden Blade")
    .description(
      'Nhận +1 Speed và Power "Critical Strike". Nếu có Archetype "Assassins", chắc chắn sử dụng được vũ khí này.',
    )
    .weight(2.86)
    .addStat("speed", 1)
    .effect({
  ...
  defineEffect("weapon", "Halberd")
    .description(
      "(1).Nếu có trên 7 Strength, tăng tỉ lệ dùng được vũ khí này lên thêm 35% (2).Sau Combat: Khi thắng round Str, nhận +1 BIQ, +1MA",
    )
    .weight(2.86)
    .effect({
      type: "custom",
  ...
  defineEffect("weapon", "Morningstar")
    .description(
      "+2 STR. Trong combat: +2 STR nếu đối thủ dùng vũ khí Physical.",
    )
    .weight(2.86)
    .addStat("strength", 2)
    .effect({
  ...
  defineEffect("weapon", "Blood Sword")
    .description(
      "+2 SPD, +2 BIQ. Sau combat thắng: Mất 1 Power để +1 STR, +1 MA.",
    )
    .weight(2.86)
    .addStat("speed", 2)
    .addStat("biq", 2)
  ...
  defineEffect("weapon", "Astrologer's Staff")
    .description(
      'Trong Combat: Khi Power "Trong Combat" kích hoạt lần đầu, +1 BIQ.',
    )
    .weight(2.86)
    .effect({
      type: "custom",
  ...
  defineEffect("weapon", "Desolator (Normal)")
    .description(
      "(1).Trước Combat: Nhận +3 Strength (2).Debuff: Đối thủ -3 Durability.",
    )
    .weight(2.86)
    .effect({
      type: "stat_modifier",
  ...
  defineEffect("weapon", "Infinity Edge")
    .description(
      "+3 STR và Power Critical Strike. Trong Combat: Mỗi khi crit, +1 điểm.",
    )
    .weight(2.94)
    .addStat("strength", 3)
    .effect({
  ...
  defineEffect("weapon", "Death's Scythe")
    .description(
      "Debuff: Đối thủ -0 all stats. +1 debuff với mỗi 51 người chết.",
    )
    .weight(2.94)
    .effect({
      type: "custom",
  ...
  defineEffect("weapon", "Yamato Blade")
    .description(
      "+2 SPD, +1 MA. Trong combat: +1 điểm khi thắng round SPD và MA.",
    )
    .weight(2.94)
    .addStat("speed", 2)
    .addStat("ma", 1)
  ...
  defineEffect("weapon", "Divine Rapier")
    .description(
      "(1).Nhận +2 all stats. (2).Debuff: Đối thủ nhận -1 all stats. (3).Khi thua trận người sở hữu sẽ mất vũ khí này.",
    )
    .weight(2.94)
    .addAllStats(2)
    .effect({
  ...
  defineEffect("weapon", "Bloodthrist Dagger")
    .description(
      '(1).Nhận Power "Critical Strike" (2).Trong Combat: Tăng thêm 16% tỉ lệ crit của "Critical Strike".',
    )
    .weight(2.94)
    .effect({
      type: "grant_power",
  ...
  defineEffect("weapon", "Ruyi Jingu Bang")
    .description(
      "(1).Trước Combat: Nhận +1 all stats với mỗi 3 power sở hữu. Hiệu ứng này chỉ có hiệu lực trong combat đó. (2).Sau Combat thắng: Có 72% nhận 1 Power ngẫu nhiên.",
    )
    .weight(2.94)
    .effect({
      type: "custom",
  ...
  defineEffect("weapon", "Mjolnir")
    .description(
      "Nhận +5 Strength, +3 Speed và +1 Dura. Sau combat thắng: Nhận +2 vào 1 chỉ số ngẫu nhiên. Sau combat thua: Mất đi vũ khí này và trả lại nó về vòng quay.",
    )
    .weight(2.94)
    .addStat("strength", 5)
    .addStat("speed", 3)
  ...
  defineEffect("weapon", "Great Highland Bagpipe")
    .description(
      "+1 all stats. Trước Combat: +1 all stats nếu có nhiều power hơn đối thủ.",
    )
    .weight(2.94)
    .addAllStats(1)
    .effect({
  ...
  defineEffect("weapon", "Yoriichi's Black Nichirin")
    .description(
      "Trong Combat: Mặc định thắng Demon. Khi không còn Demon, +3 all stats.",
    )
    .weight(2.94)
    .effect({
      type: "custom",
  ...
  defineEffect("weapon", "Instruments of the Sirens")
    .description(
      "Trong Combat: Đối thủ -1 all stats. Sau combat: +2 random stat.",
    )
    .weight(2.94)
    .effect({
      type: "debuff",
  ...
  defineEffect("weapon", "Chastiefol")
    .description(
      "Trước Combat: Nhận +3 cho bản thân vào 2 Stat thấp nhất của đối phương.",
    )
    .weight(2.94)
    .effect({
      type: "custom",
  ...
  defineEffect("weapon", "Saitama's Gloves")
    .description(
      "Nhận +3 Strength. Bắt đầu trận đấu, quay 1 chỉ số ngẫu nhiên. Khi chiến thắng chỉ số đó, nhận +1 điểm. Nếu đó là Strength, thắng luôn Combat.",
    )
    .weight(2.94)
    .addStat("strength", 3)
    .effect({
  ...
  defineEffect("weapon", "Galeforce")
    .description(
      "Round đầu tiên thua trong combat đối phương sẽ không nhận điểm và không thể kích hoạt các hiệu ứng (ví dụ: Crit) Sau Combat: Nếu tổng điểm đối thủ =0 hoặc âm, nhận +3 vào 1 chỉ số ngẫu nhiên.",
    )
    .weight(2.94)
    .effect({
      type: "custom",
  ...
  defineEffect("weapon", "Battlefury")
    .description(
      "(1).Trong Combat: Round thua đầu tiên sẽ khiến đối thủ sẽ không nhận được điểm và không thể kích hoạt các Feature. (2).Sau Combat: Nếu tổng điểm đối thủ bằng 0 hoặc âm, nhận +3 vào 1 chỉ số ngẫu nhiên.",
    )
    .weight(2.94)
    .effect({
      type: "custom",
  ...
  defineEffect("weapon", "Moonveil")
    .description(
      "Trước Combat: +1 điểm nếu Base IQ cao hơn. +1 điểm nếu nhiều Power hơn.",
    )
    .weight(2.94)
    .effect({
      type: "custom",
  ...
  defineEffect("weapon", "Misericorde")
    .description(
      "Trong Combat: Mỗi khi thua round, 10% nhận điểm thay vì đối thủ.",
    )
    .weight(2.94)
    .effect({
      type: "custom",
  ...
  defineEffect("weapon", "Andúril")
    .description(
      "(1).Sau Combat: Nhận Summon Wheel. (2).Trước Combat: Khi Combat với Demon, Vampire, Spirit, Orc, Skeleton và Goblin, +1 điểm khởi đầu với mỗi 3 Summon hiện có.",
    )
    .weight(2.94)
    .effect({
      type: "wheel_grant",
  ...
  defineEffect("weapon", "Needle")
    .description(
      "Trong Combat: Thắng Round có Base Stat thấp nhất của đối thủ, +2 điểm.",
    )
    .weight(2.94)
    .effect({
      type: "custom",
  ...
  defineEffect("weapon", "12 đôi dép")
    .description(
      "Sau Combat thua: +3 và +6 vào 2 stat bất kì. Ở chung kết, nhận thêm 1 lần nữa.",
    )
    .weight(2.94)
    .effect({
      type: "custom",
  ...
  defineEffect("weapon", "Rhitta")
    .description(
      "Nhận +3 Strength và +2 Dura. Trong combat: Có 33% gấp đôi hiệu ứng cộng chỉ số từ vũ khí này.",
    )
    .weight(2.94)
    .addStat("strength", 3)
    .addStat("durability", 2)
  ...
  defineEffect("weapon", "Hou Yi's Divine Bow")
    .description(
      "Sau combat: Nhận vòng quay Hậu Nghệ. Bắn 9 mặt trời, +3 all stats.",
    )
    .weight(2.94)
    .effect({
      type: "wheel_grant",
  ...
  defineEffect("weapon", "Medusa's Head")
    .description(
      "-1 all stats. Trong combat: Nhận điểm thay đối thủ khi họ nhận từ hiệu ứng.",
    )
    .weight(2.94)
    .addAllStats(-1)
    .effect({
  ...
  defineEffect("weapon", "Giant Slayer")
    .description(
      "Trong combat: +1 điểm với mỗi 4 Base Dura của đối thủ (tối đa 2).",
    )
    .weight(2.94)
    .effect({
      type: "custom",
  ...
  defineEffect("weapon", "Flower of Fire")
    .description(
      "Sau combat thắng: +1 random stat với mỗi 2 Power. Sau combat thua: +2 Power.",
    )
    .weight(2.94)
    .effect({
      type: "custom",
  ...
  defineEffect("weapon", "Infinity Gauntlet")
    .description(
      "Quay 6 người chơi nhận đá vô cực. Khi họ bị loại, nhận đá của họ.",
    )
    .weight(2.94)
    .effect({
      type: "custom",
  ...
  defineEffect("weapon", "Eclipse Shotel")
    .description(
      "Sau Combat thắng: Đối thủ -2 All Stats, chia tay Lover. Chữa AIDS, loại bỏ Femboy.",
    )
    .weight(2.94)
    .effect({
      type: "custom",
  ...
  defineEffect("weapon", "Bolt of Gransax")
    .description(
      "Trong Combat: Thắng Round SPD, +2 điểm/round thay vì 1 cho phần còn lại.",
    )
    .weight(2.94)
    .effect({
      type: "custom",
...
registerImmediateHandler(
  ...
  (_ctx: ImmediateHandlerContext): ImmediateHandlerResult => {
    return {
      skipDefault: true,
      description:
        "Infinity Gauntlet: Quay 6 người chơi nhận 6 Infinity Stones. Khi bị loại, đá trở về Gauntlet.",
    };
  },
...
registerCombatHandler(
  ...
  (ctx: CombatHandlerContext): CombatHandlerResult => {
    ...
    return {
      description: `Banana Peel: IQ bằng nhau (${selfBaseIQ}), không có hiệu ứng`,
    };
  },
...
registerCombatHandler(
  ...
  (_ctx: CombatHandlerContext): CombatHandlerResult => {
    ...
    return {
      description:
        "Cursed Pennywort: Vô hiệu hóa 3 power ngẫu nhiên của đối thủ",
    };
  },
...
registerCombatHandler(
  ...
  (ctx: CombatHandlerContext): CombatHandlerResult => {
    ...
    const hasPhysical = opponentWeapons.some((w: any) => {
      ...
      const name: string = (typeof w === "string" ? w : (w?.name ?? ""))
        .replace(/\s*\(.*?\)/g, "")
        .trim();
...
registerCombatHandler(
  ...
  (ctx: CombatHandlerContext): CombatHandlerResult => {
    ...
    return {
      description: `Bagpipe: Không nhiều power hơn (${selfPowers} <= ${oppPowers})`,
    };
  },
...
registerCombatHandler(
  ...
  (ctx: CombatHandlerContext): CombatHandlerResult => {
    ...
    return {
      description: `Sarastro's Flute: Đối thủ chưa đủ 3 power (${oppPowers})`,
    };
  },
...
registerCombatHandler(
  ...
  (ctx: CombatHandlerContext): CombatHandlerResult => {
    ...
    if (points > 0) {
      return {
        selfPoints: points,
        description: `Moonveil: ${desc.join(", ")}`,
      };
    }
...
registerCombatHandler(
  ...
  (ctx: CombatHandlerContext): CombatHandlerResult => {
    ...
    const sorted = [...STAT_NAMES].sort(
      (a, b) =>
        (ctx.opponent!.stats as Record<StatName, number>)[a] -
        (ctx.opponent!.stats as Record<StatName, number>)[b],
    );
...
registerCombatHandler(
  ...
  (_ctx: CombatHandlerContext): CombatHandlerResult => {
    return {
      description:
        "Diffusal Blade: Vô hiệu hóa Gear/Weapon có tag Magic của đối phương",
    };
  },
  ...
  (ctx: CombatHandlerContext): CombatHandlerResult => {
    ...
    if (activations === 1) {
      return {
        ...
        description:
          "Astrologer's Staff: Power Trong Combat kích hoạt lần đầu → +1 BIQ",
      };
    }
    return { skipDefault: true };
  },
...
registerCombatHandler(
  ...
  (_ctx: CombatHandlerContext): CombatHandlerResult => {
    ...
    return {
      skipDefault: true,
      description:
        "Saitama's Gloves: Xác định stat bởi wheel trước combat (xem CombatEffectsPanel)",
    };
  },
  ...
  (ctx: CombatHandlerContext): CombatHandlerResult => {
    ...
    if (ctx.self.roundsLost === 0) {
      return {
        opponentPoints: -1,
        description:
          "Galeforce: Round thua đầu tiên → đối thủ không nhận điểm round này",
      };
    }
    return { skipDefault: true };
  },
  ...
  (ctx: CombatHandlerContext): CombatHandlerResult => {
    ...
    if (ctx.self.roundsLost === 0) {
      return {
        opponentPoints: -1,
        description:
          "Battlefury: Round thua đầu tiên → đối thủ không nhận điểm round này",
      };
    }
    return { skipDefault: true };
  },
...
registerCombatHandler(
  ...
  (ctx: CombatHandlerContext): CombatHandlerResult => {
    if (!ctx.opponent) return { skipDefault: true };
    const oppBaseDura =
      (ctx.opponent.baseStats as any).dur ??
      (ctx.opponent.baseStats as any).durability ??
      0;
    ...
    return {
      description: `Giant Slayer: Đối thủ chưa đủ 4 Base Dura (${oppBaseDura})`,
    };
  },
...
registerCombatHandler(
  ...
  (ctx: CombatHandlerContext): CombatHandlerResult => {
    ...
    let lowestVal = (ctx.opponent.baseStats as Record<StatName, number>)
      .strength;
    for (const stat of STAT_NAMES) {
      if (
        (ctx.opponent.baseStats as Record<StatName, number>)[stat] < lowestVal
      ) {
...
registerCombatHandler(
  ...
  (_ctx: CombatHandlerContext): CombatHandlerResult => {
    return {
      ...
      description:
        "Eclipse Shotel: Đối thủ -2 all stats, mất Lover. Bản thân chữa AIDS, loại Femboy.",
    };
  },
  ...
  (ctx: CombatHandlerContext): CombatHandlerResult => {
    ...
    if (!demonAlive && allChars.length > 0) {
      return {
        ...
        description:
          "Yoriichi's Black Nichirin: Không còn Demon → +3 all stats",
      };
    }
    return { skipDefault: true };
  },
...
registerCombatHandler(
  ...
  (_ctx: CombatHandlerContext): CombatHandlerResult => {
    ...
    return {
      skipDefault: true,
      description:
        "Rhitta: 33% gấp đôi stat bonus (xác suất quyết định bởi wheel UI)",
    };
  },
...
registerCombatHandler(
  ...
  (ctx: CombatHandlerContext): CombatHandlerResult => {
    const oppPoints =
      (ctx as any).opponentTotalPoints ??
      (ctx.opponent ? (ctx as any).opponentPoints : null);
    // Check via opponentPoints field or fallback: only grant if opponent ended ≤0 points
    if (oppPoints === null || oppPoints === undefined || oppPoints > 0)
      return { skipDefault: true };
